...
class PaymentBloc extends Bloc<PaymentEvent, PaymentState> {
  ...
  Future<Map<String, dynamic>> _callPayEndpointIntentId({
    ...
    final url = Uri.parse(
        'https://us-central1-internetpraktikum.cloudfunctions.net/StripePayEndpointIntentId');
  ...
  Future<Map<String, dynamic>> _callPayEndpointMethodId({
    ...
    final url = Uri.parse(
        'https://us-central1-internetpraktikum.cloudfunctions.net/StripePayEndpointMethodId');
